...
<head> <!-- Required meta tags -->
  ...
  <title>
    SGD | Editar sua Distribuidora </title>
  <style>
    body {
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="div-menor">
            ...
            <button id="notify" class="btn btn-info btn-md btn-block text-light" onclick="exibirMensagemDeSucesso()">
          ...
          <div class="card-body">
            <form action="{{ route('user.update', $data->_id)}}" method="post">
              ...
              <div class="form-group">
                <label for="nameRegister">Nome de usuário:</label><input type="text" class="form-control" name="name"
                  id="nameRegister" value="{{$data->name}}">@error('name')
                <div class="invalid-nameRegister">
                  <p class="text-danger">
                    {{$message}}
                  </p>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="(XX) XXXX-XXXX" oninput="formatarTelefone(this)"
                  name="cel_phone" id="cel_phoneRegister" value="{{$data->cel_phone}}">@error('cel_phone')
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="(XX) XXXX-XXXX" oninput="formatarTelefone(this)"
                  name="fix_phone" id="fix_phoneRegister" value="{{$data->fix_phone}}">@error('fix_phone')
              ...
              <div class="form-group">
                <label for="passwordRegister">Senha:</label><input type="password" name="password" class="form-control"
                  id="passwordRegister" value="">@error('password')
                <div class="invalid-nameRegister">
                  <p class="text-danger">
                    {{$message}}
                  </p>
